...
namespace Skybrud.Social.Basecamp.Models.Bcx.People {
    ...
    public class BcxPersonItem : JsonObjectBase {
        ...
        protected BcxPersonItem(JObject json) : base(json)  {
            Id = json.GetInt64("id");
        ...
        /// <summary>
        /// Parses the specified <paramref name="json"/> object into an instance of <see cref="BcxPersonItem"/>.
        /// </summary>
        /// <param name="json">The instance of <see cref="JObject"/> to be parsed.</param>
        /// <returns>An instance of <see cref="BcxPersonItem"/>.</returns>
        public static BcxPersonItem Parse(JObject json) {
            return json == null ? null : new BcxPersonItem(json);
        }
